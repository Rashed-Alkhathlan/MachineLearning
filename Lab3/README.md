...
Columns include product info (product_id, product_name, category), pricing (discounted_price, actual_price, discount_percentage), ratings (rating, rating_count), and reviews (review_title, review_content). Multi-label categories are separated by |.
